...
app.post('/getAllMsg', (req, res) => {
  ...
  Msg.find({email: email}).then((yes) => {

    // parse json
    var b = JSON.stringify(yes);
    var jsonParsed = JSON.parse(b);
    ...
    var msg = jsonParsed[i].msg;
     newpass = jsonParsed[i].password;

     //newmsg = newmsg+ '{ msg:' + msg + '},';
         result.push({msg: msg});
